...
def translate_yogam(yog_str, lang):
    ...
    translations = {
        ...
        "ml": ["വിഷ്കംഭം", "പ്രീതി", "ആയുഷ്മാൻ", "സൗഭാഗ്യം", "ശോഭനം", "അതിഗണ്ഡം", "സുകർമ്മം", "ധൃതി", "ശൂലം", "ഗണ്ഡം", "വൃദ്ധി", "ധ്രുവം", "വ്യാഘാതം", "ഹർഷണം", "വജ്രം", "സിദ്ധി", "വ്യതീപാതം", "വരിയാൻ", "പരിഘം", "ശിവം", "സിദ്ധം", "സാധ്യം", "ശുഭം", "ശുക്ലം", "ബ്രഹ്മം", "ഇംദ്രൻ", "വൈധൃതി"],
...
def translate_anandadi_yoga(name, quality, lang):
    # Tamil-panchangam day yoga: Siddha / Amirtha / Marana, or none ("--").
    if not name or name == "None":
        return "--"
    yoga_names = {
        "Siddha":  {"en": "Siddha", "ta": "சித்த", "te": "సిద్ధ", "ml": "സിദ്ധ", "kn": "ಸಿದ್ಧ", "hi": "सिद्ध"},
        "Amirtha": {"en": "Amirtha", "ta": "அமிர்த", "te": "అమృత", "ml": "അമൃത", "kn": "ಅಮೃತ", "hi": "अमृत"},
...
LABEL_LOCALIZATION = {
    "en": {
        ...
        "yogam": "Yogam", "anandadi": "Anandadi Yoga", "karanam": "Karanam", "sunrise": "Sunrise Time", "sunset": "Sunset Time",
    ...
    "ta": {
        ...
        "yogam": "யோகம்", "anandadi": "ஆனந்தாதி யோகம்", "karanam": "கரணம்", "sunrise": "சூரிய உதயம்", "sunset": "சூரிய அஸ்தமனம்",
    ...
    "te": {
        ...
        "yogam": "యోగం", "anandadi": "ఆనందాది యోగం", "karanam": "కరణం", "sunrise": "సూర్యోదయం", "sunset": "సూర్యాస్తమయం",
    ...
    "ml": {
        ...
        "yogam": "യോഗം", "anandadi": "ആനന്ദാദി യോഗം", "karanam": "കരണം", "sunrise": "സൂര്യോദയം", "sunset": "സൂര്യാസ്തമയം",
    ...
    "kn": {
        ...
        "yogam": "ಯೋಗ", "anandadi": "ಆನಂದಾದಿ ಯೋಗ", "karanam": "ಕರಣ", "sunrise": "ಸೂರ್ಯೋದಯ", "sunset": "ಸೂರ್ಯಾಸ್ತ",
    ...
    "hi": {
        ...
        "yogam": "योग", "anandadi": "आनंदादि योग", "karanam": "करण", "sunrise": "सूर्योदय", "sunset": "सूर्यास्त",
...
def generate_pdf_report(chart_data, client_name, place_name, visual_style="south", output_path="/home/prasanth/Vedic_Rag/birth_chart_report.pdf", lang="en"):
    ...
    # Right Box Data Fill (12 fields with 13.5 spacing)
    c.setFont(FONT_REGULAR, 7.5)
    c.setFillColor(HexColor("#2D3748"))
    ...
    anandadi_local = translate_anandadi_yoga(
        chart_data['panchangam'].get('anandadi_yoga'),
        chart_data['panchangam'].get('anandadi_quality'), lang)
    ...
    panch_fields = [
        ...
        (labels["anandadi"], anandadi_local),
